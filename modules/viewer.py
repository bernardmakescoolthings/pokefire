"""Serve the local Pokefire control panel: python -m modules.viewer (no dependencies)."""
...
from modules.monitor_lock import running
from pokefire import load_config, State
        ...
        with self.lock:
            ...
            with (self.log_dir / f"{source}.log").open("w") as log:
                self.children[source] = subprocess.Popen(
                    [sys.executable, "-u", str(ROOT / "pokefire.py"), "--config", str(self.config_path),
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            if url.path in assets:
                ...
                return self.reply(200, (ROOT / "viewer" / name).read_bytes(), mime)
